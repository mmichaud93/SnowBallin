...
namespace SnowBallin
{
	public class MenuScene : Sce.PlayStation.HighLevel.GameEngine2D.Scene
	{
		...
		public MenuScene ()
		{
			...
			ib.Image = new ImageAsset("/Application/assets/art/splashscreen-01.png",false);
			...
			buttonUI1.Alpha = 0.95f;
			buttonUI1.SetPosition(dialog.Width/2 - buttonUI1.Width/2,200.0f);
			buttonUI1.TouchEventReceived += (sender, e) => {
				new GameStart();
			};
			
			Button buttonUI2 = new Button();
			buttonUI2.Name = "buttonQuit";
			buttonUI2.Text = "Quit";
			buttonUI2.Width = 600;
			buttonUI2.Height = 100;
			buttonUI2.Alpha = 0.95f;
			buttonUI2.SetPosition(dialog.Width/2 - buttonUI2.Width/2,325.0f);
